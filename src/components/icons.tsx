...
export function RibbonStarIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      ...
      <path d="m9 13.5-1.5 7L12 18l4.5 2.5-1.5-7" strokeLinecap="round" strokeLinejoin="round" />
      <path d="m9.5 8 1.8 1.8L14.5 6.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IdBadgeIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      ...
      <path d="M6 17c.6-1.8 2-2.5 3-2.5s2.4.7 3 2.5" strokeLinecap="round" />
